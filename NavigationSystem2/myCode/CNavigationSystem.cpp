...
void CNavigationSystem::setMediaName(string name)
{
	wpName = name+"-wp.txt";
...
bool CNavigationSystem::writeData(const CWpDatabase& waypointDb,
...
void CNavigationSystem::trim(string& obj){
	/*
...
bool CNavigationSystem::readData(CWpDatabase& waypointDb, CPoiDatabase& poiDb,
		MergeMode mode)
{
...
void CNavigationSystem::printError(int errorNo, string objName, int lineNo)
{
...
void CNavigationSystem::enterRoute(){
	...
	bool fileerror = this->readData(this->m_WpDatabase,this->m_PoiDatabase,MERGE);
	...
	cr.addWaypoint("asdasd");//for error check
	...
	cr.addPoi("mensa","Darmstadt");
	cr.addPoi("sitte","Berlin");
	cr.addPoi("dio","Amsterdam");
