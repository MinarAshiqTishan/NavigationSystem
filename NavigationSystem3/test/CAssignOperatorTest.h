...
#ifndef CASSIGNOPERATORTEST_H_
#define CASSIGNOPERATORTEST_H_
...
class CAssignOperatorTest: public CppUnit::TestFixture {
private:
	CRoute* cr;
	CWaypoint* amsterdam;
	CWaypoint* darmstadt;
...
public:
	...
	static CppUnit::TestSuite* suite() {
		CppUnit::TestSuite* suite = new CppUnit::TestSuite("Assignment Operator Tests");


		suite->addTest(new CppUnit::TestCaller<CAssignOperatorTest>
		("Assigned all", &CAssignOperatorTest::testCopy));
